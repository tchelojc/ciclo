...
class TimelineWidget(QGraphicsView):
    ...
    def calculate_cosmic_data(self, year, month=None, day=None):
        ...
        try:
            ...
            return {
                ...
                'earth_angle': astronomy.earth_heliocentric_position(date)
            }
    ...
    def show_event_detail(self, event_data):
        ...
        cosmic_info = QLabel(f"""
            ...
            <p><b>Baktun:</b> {cosmic_data.get('baktun', 0):.2f}</p>
            <p><b>Fase de Vênus:</b> {cosmic_data.get('venus_phase', 0):.1f}°</p>
            <p><b>Ano Galáctico:</b> {cosmic_data.get('galactic_year', 0):.1f}°</p>
        """)
